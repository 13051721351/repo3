...
<link href="media/bs/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
	<script  src="media/jquery/jquery-3.1.0.js" type="text/javascript" ></script>
	<script  src="media/bs/js/bootstrap.min.js"  type="text/javascript"></script>
